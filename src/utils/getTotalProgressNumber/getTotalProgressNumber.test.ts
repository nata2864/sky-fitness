...
describe('getTotalReps', () => {
  it('должна возвращать число повторений из скобок', () => {
    ...
    expect(getTotalProgressNumber('Наклон к согнутой правой ноге (10 повторений)')).toBe(10);
  ...
  it('должна возвращать 0, если число не найдено', () => {
    ...
    expect(getTotalProgressNumber('Наклон к согнутой правой ноге (повторений)')).toBe(0);
